    ...
    <header className="sticky top-0 z-50 border-b border-white/5 bg-black/30 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Auth buttons always visible on all pages */}
          ...
          {/* Mobile: keep CTA visible even without opening menu */}
          <Link href="/register" className="sm:hidden rounded-xl bg-accent px-3 py-2 text-sm font-extrabold text-black">
            Kayıt Ol
          </Link>
